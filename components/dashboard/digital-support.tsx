    ...
    return (
        <div id="tour-support-main" className="min-h-screen">
            <div className="max-w-7xl mx-auto px-6 pt-0 pb-6 space-y-8">
                ...
                {/* Support Services */}
                <Card id="tour-support-services" className="border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                                    ...
                                    <div key={item.type} className={`border rounded-lg p-4 sm:p-6 ${cardBgClass}`}>
                                        <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-4 space-y-4 sm:space-y-0">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-gray-600 text-sm leading-relaxed mb-4 dark:text-gray-400">{item.description}</p>
                                                {'built' in item ? (
                                                    <div className="flex items-center space-x-2">
                                                        {(item as SupportItemWithBuilt).built ? (
                                                            <>
                                                                <CheckCircle className="h-5 w-5 text-emerald-600 dark:text-emerald-500" />
                                                                <span className="text-sm font-medium text-emerald-700 dark:text-emerald-400">Built & Ready</span>
                                                            </>
                                                        ) : (
                                                            <>
                                                                <Globe className="h-5 w-5 text-gray-400 dark:text-gray-500" />
                                                                <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Not Built Yet</span>
                                                            </>
                                                        )}
                                                    </div>
                                                ) : (
                                                    <>
                                                        {(item as SupportItemWithLimits).total === 0 ? (
                                                            <div className="space-y-3">
                                                                <div className="flex items-start gap-2 p-3 bg-red-50 border border-red-200 rounded-lg dark:bg-red-950/40 dark:border-red-900">
                                                                    ...
                                                                    <div className="flex-1">
                                                                        <p className="text-sm font-medium text-red-800 mb-1 dark:text-red-300">
                                                            ...
                                                            <div className="space-y-3">
                                                                <div className="flex justify-between items-center text-sm">
                                                                    ...
                                                                    <span className={`font-medium ${isLimitExhausted ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'}`}>
                                                                ...
                                                                <div className="flex justify-between items-center">
                                                                    <p className={`text-xs ${isLimitExhausted ? 'text-red-600 font-medium dark:text-red-400' : 'text-gray-500 dark:text-gray-500'}`}>
                                                                    ...
                                                                    {isLimitExhausted && (
                                                                        <Badge className="bg-red-100 text-red-800 text-xs px-2 py-0.5 dark:bg-red-900 dark:text-red-200">
                                                                            Limit Reached
                                                                        </Badge>
                                                                    )}
                                                                </div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-4 space-y-4 sm:space-y-0">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-2">
                                                <h4 className="font-semibold text-gray-900 text-base dark:text-white">{request.title}</h4>
                                                {request.priority && (
