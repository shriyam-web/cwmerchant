      ...
      <div className="border-2 rounded-xl p-6 bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-950/20 dark:to-amber-900/20 border-amber-200 dark:border-amber-800">
        ...
        <div className="space-y-4">
          {faqFieldArray.fields.map((faqField, index) => (
            <div key={faqField.id} className="space-y-3 rounded-xl border-2 border-gray-200 dark:border-gray-800 p-5 bg-white/50 dark:bg-gray-900/50">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2">
                  <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-gray-500 text-xs font-bold text-white shadow-md">
                    {index + 1}
                  </span>
                  <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">FAQ {index + 1}</span>
                </div>
                <Button
                  type="button"
                  variant="ghost"
                  ...
                  className="hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-gray-950/30"
                >
