...
export default function Dashboard() {
  ...
  const recentRequests = [
    { id: '1', customer: 'Rahul Sharma', amount: '₹1,250', status: 'pending', time: '2 hours ago' },
    { id: '2', customer: 'Priya Singh', amount: '₹850', status: 'approved', time: '5 hours ago' },
    { id: '3', customer: 'Amit Kumar', amount: '₹2,100', status: 'pending', time: '1 day ago' }
  ];
                    ...
                    <div key={request.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        ...
                        <Badge 
                          ...
                          className={request.status === 'approved' ? 'bg-green-600' : 'bg-orange-500'}
                        >
                          {request.status}
                        </Badge>
                      </div>
          ...
          <div className="p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                ...
                {activeTab === 'offers' && 'Create and manage your special offers and promotions.'}
                {activeTab === 'products' && 'Add and manage your products and services.'}
                {activeTab === 'requests' && 'Review and approve customer purchase requests.'}
                {activeTab === 'profile' && 'Manage your business profile and settings.'}
                {activeTab === 'support' && 'Request digital marketing materials and support.'}
              </p>
            </div>
